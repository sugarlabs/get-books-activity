...
class GetIABooksActivity(activity.Activity):
    ...
    def show_book_data(self, load_image=True):
        ...
        book_data = _('Title:\t\t') + str(self.selected_title) + '\n'
        self.selected_author = self.selected_book.get_author()
        book_data += _('Author:\t\t') + str(self.selected_author) + '\n'
        ...
        if (self.selected_summary is not 'Unknown'):
            book_data += _('Summary:\t') + str(self.selected_summary) + '\n'
        ...
        if self.selected_language_code != '':
            ...
            book_data += _('Language:\t') + str(self.selected_language) + '\n'
        book_data += _('Publisher:\t') + str(self.selected_publisher) + '\n'
        if self.source != 'local_books':
            try:
